...
namespace Lab3
{
    public partial class frmSinhVien : Form
    {
        ...
        private void ThietLapThongTin(SinhVien sv)
        {
            ...
            this.dtpNgaySinh.Text = sv.DiaChi;
       ...
       private void frmSinhVien_Load (object sender, EventArgs e)
        ...
        {
            SinhVien sv = obj1 as SinhVien;
            return sv.MaSo.CompareTo(obj2);
        }
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            ...
            DialogResult isOK = openFile.ShowDialog();
        ...
        {
            frmTuyChon fr = new frmTuyChon();
            fr.Show();
        }

        private void toolStripMenuItem9_ForeColorChanged(object sender, EventArgs e)
        {
