...
namespace QLGiay
{
    public partial class frmAccountProfile : Form
    {
        ...
        {
            txtDisplayName.Text = LoginAccount.UserName;
            txtUserName.Text = LoginAccount.DisplayName;
        }
        ...
        void UpdateAccountInfo()
        {
            ...
            {
                MessageBox.Show("Please match password that you have type!");
            }
            else
            {
                ...
                {
                    MessageBox.Show("Please gimme the right password");
                }
            }
        }
